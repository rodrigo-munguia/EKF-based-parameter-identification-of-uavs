...
% gravity force expressed in the body frame 
 ...
 % propultion force
   ...
   %--------------------------
    ...
    x0 = [pn0 pe0 pd0 u0 v0 w0 phi0 theta0 psi0 p0 q0 r0 Jx0 Jy0 Jz0 b0 k0]';
    ...
    %}
     ...
     % y7_0 ; y7_1; y7_2; y8_0 ; y8_1; y8_2 ; y9_0; y9_1 ; y9_2 ;     
 ...
 %   Q = [y1_0;y1_1; y2_0; y2_1; y3_0; y3_1 ; y3_2;   y10_0 ; y10_1 ;   y11_0 ; y11_1;          y12_0; y12_1 ; y12_2  ] 
 

 
 %Q = [  y7_0 ; y7_1; y7_2; y8_0 ; y8_1 ; y8_2; y9_0 ; y9_1 ; y9_2;  y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2 ] 
 
 
 
 %--------------------------------------------------------------------------
 % Not full rank (but states of paramters can be observable)
 
 % pn , pe , pd not observable  (configuration  c )
 %  Q = [  y4_0 ; y4_1; y4_2; y5_0 ; y5_1 ; y5_2; y6_0 ; y6_1 ; y6_2;  y7_0 ; y8_0 ; y9_0; y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2 ] % x, +  ,h

 % phi, theta, psi not observable (configuration d )  p0, q0, r0 <> 0
 %Q = [y1_0;y1_1; y1_2 ; y2_0; y2_1; y2_2; y3_0; y3_1 ; y3_2;    y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2 ] % x, +, h
 
 % pn , pe , pd ,  psi  not observable (configuration e) p0, q0, r0 <> 0
 %Q = [  y4_0 ; y4_1; y4_2; y5_0 ; y5_1 ; y5_2; y6_0 ; y6_1 ; y6_2;  y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2 ] % x, +, h
 
 % (configuration f)
 Q = [ y3_0; y3_1 ; y3_2;    y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2 ]  % x, +, h
 
 %-------------------------------------------------------------------------
   % Full rank
 %  Q = [y1_0; y2_0; y3_0 ; y4_0 ; y5_0 ; y6_0 ; y6_1; y7_0 ; y8_0 ; y9_0; y10_0 ; y10_1 ; y10_2; y11_0 ; y11_1; y11_2;  y12_0; y12_1 ; y12_2 ] % x , + ,h
 %   Q = [y1_0; y2_0; y3_0 ; y4_0 ; y5_0 ; y6_0 ; y6_1; y7_0 ; y8_0 ; y9_0; y10_0 ; y10_1 ;         y11_0 ; y11_1;          y12_0; y12_1 ; y12_2  ] % x, +, h
    
 %  configuration b :  p0, q0, r0 <> 0
 %Q = [y1_0;y1_1; y1_2 ; y2_0; y2_1; y2_2; y3_0; y3_1 ; y3_2;    y7_0 ; y7_1; y7_2; y8_0 ; y8_1 ; y8_2; y9_0 ; y9_1 ; y9_2;  y10_0 ; y10_1 ; y10_2;  y11_0 ; y11_1;  y11_2;   y12_0; y12_1 ; y12_2  ] % x, + , h
    % if p0 = q0 = 0 the derivative y12_2  becomes linear dependent
...
%----------------------------------------------------------------------
    ...
    %s = eval(subs(simplify(dy12dotdot_dx(13)), Jxz, 0 ))
    %collect(s,[p q])
